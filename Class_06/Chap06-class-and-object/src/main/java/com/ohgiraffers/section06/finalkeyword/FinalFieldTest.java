...
public class FinalFieldTest {
    ...
    /*
        ...
        final 키워드를 사용할 수 있는 위치는 다양한 편이며 의마가 약간은 다르지만 결국 변경 불가의 의미를 가진다.
        ...
        6. static 메소드 : 메서드 재작성 (overriding)불가
        7. 클래스 : 상속 불가능
    */

    // 아래와 같은 상수 필드의 값을 할당하지 않으면 초기값이 0으로 고정되어 에러가 발생한다.
    ...
    /*
        ...
        기본값으로 초기화 된 후 값을 변경하지 못하기 때문에에러가 발생한다.
    */
