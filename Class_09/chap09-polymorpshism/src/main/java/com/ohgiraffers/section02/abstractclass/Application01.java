...
public class Application01 {
    public static void main(String[] args) {
        ...
        /*
            ...
            이 때 푸상클래스는 상위 타입으로 사용될 수 있으며, 다형성을 이용할 수 있다.

            추상클래스에 작성한 추상메소드는 반드시 후손이 어버라이딩 해서 작성해야 하며,
            후손 클래스들의 메소드를의 공통 인터페이스로의 역할을 수행할 수 있다.
            추상클래스에 작성한 메소드를 호출하게되면 실제 후손 타입의 인스턴스가 가지는 메소드는 다형성이 적용되어 동적바인딩에 의해
            다양한 응답을 할 수 된다.
            ...
            추상메소드의 경우 반드시 abstrat 키워드를 메소드 헤드에 작성해야 한다.
...
//        Product pro = new Produc(); 추상 클래스는 인스턴스 생성 불가
