...
public class Application03 {
    public static void main(String[] args) {
        /*
            ...
            또한, 규칙에 맞는 올바른 변수명을 짓는 것이 좋은 프로그램잉을 하는 첫 단추이다.
        */
        ...
        /*
            ...
            2. 컴파일 에러를 발생시킺는 않지만 개발자들끼리의 암묵적인 규칙
                2-1. 변수명의 길이는 제한이 없다.
                     int dadasdadasgwga;
                2-2. 변수명의 합성어로 이루어진 첫 단어는 소문자, 두 번째 시작 단어는 대문자로 시작한다 (camel-cas)
                     int maxNum;
                2-3. 단어와 단어 사이의 연결을 언더스코어로(_) 하지 않는다.
                2-4. 한글로 변수명을 짓는 것이 간으하지만, 권장하지 않는다.
                     int 숫자;
                2-5. 변수 안에 저장될 값이 어떤 의미를 가지는지 명확하게 표현하도록 한다.
                     int point;
