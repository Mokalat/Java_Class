...
public class Application02 {
    public static void main(String[] args) {
        /*
            ...
            <? super Type> : 와일카드 하한 제한 (Type과 Type의 부모를 이용해 생성한 인스턴스만 인자로 사용가능)
        */
        ...
        // wildCardFarm.anyType(new RabbitFarm<RabbitFarm>(new Rabiit()));
        ...
        // RabbitFarm을 생성하는 부분에는 문제가 없다. 그러나 extendsType의 매개변수 조건을 확인하면 <? extends Bunny>가 있으면
        // 이것으로 아래의; Rabbit은 매개변수으, 조건을 위배하게된다.
        ...
        // 아래는 RabbitFarm의 조건은 만족하지만 SuperType의 조건은 만족하지 않는다. tt
